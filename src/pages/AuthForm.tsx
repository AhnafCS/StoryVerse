    ...
    <div className="w-full max-w-sm mx-auto">
      <div className="flex mb-8 border-b border-border">
        <button
          ...
          className={`flex-1 pb-3 text-sm font-body tracking-wider uppercase transition-all duration-300 ${!isSignUp
      ...
      <form className="space-y-5 transition-all duration-300" onSubmit={handleSubmit}>
        {isSignUp && (
          <div className={`transition-all duration-300 overflow-hidden ${isSignUp ? "opacity-100 max-h-32" : "opacity-0 max-h-0"
            }`}>
