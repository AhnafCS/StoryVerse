...
import {
  ...
  ChevronDown, ChevronUp, Send, Trash2, X, Image, Camera, Copy
} from "lucide-react";
...
const HomeFeed = () => {
  ...
  useEffect(() => {
    const handleOutsideClick = (e: MouseEvent) => {
      if (!(e.target as HTMLElement).closest('.sv-post-menu-container')) {
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .sv-post-dropdown-menu {
          ...
          flex-direction: column;
          gap: 2px;
          animation: svFadeIn 0.12s ease-out;
        }
        ...
        .sv-post-menu-item:hover {
          background: var(--surface-hover);
          color: var(--ink);
        }

        .sv-post-menu-item-delete {
          color: #ef4444;
        }

        .sv-post-menu-item-delete:hover {
                    ...
                    <div key={post.id} className="sv-feed-post">
                      <div className="sv-feed-post-header">
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="sv-post-menu-container">
                              <button 
                                className="sv-more-btn"
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              {activeMenuPostId === post.id && (
                                <div className="sv-post-dropdown-menu" onClick={(e) => e.stopPropagation()}>
                                  <button 
                                    className="sv-post-menu-item"
                                    onClick={() => {
                                      setActiveMenuPostId(null);
                                  ...
                                  {isOwnPost && (
                                    <button 
                                      className="sv-post-menu-item sv-post-menu-item-delete"
                                      onClick={() => {
                                        setActiveMenuPostId(null);
